                        ...
                        <div class="col-sm-5">
                            <h6 class="fs-3 fw-semibold mb-0">
                                <div class="title-block">
                                    <h4 class="fs-3 fw-esmibold mb-0"><?php echo e(__('YASEEIR ONLINE')); ?></h4>
                                    <span>
                                    <nav aria-label="breadcrumb" class="d-none d-lg-block">
                                        <ol class="breadcrumb" style="--bs-breadcrumb-divider: '/';">

                                                <li class="breadcrumb-item"><a href="<?php echo e(url('/home')); ?>"><i class="uil uil-home"></i> <?php echo e(__('Dashboard')); ?></a> 
                                ...
                                <div class="col-12 col-md-auto">
                                    <ul id="top-social" class="d-flex flex-column align-items-end gap-1">
                                        <li>
                                            ...
                                            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'admin|finance|validation|activation|it|delivery')): ?>
                                            <form action="<?php echo e(route('admin.logout')); ?>" method="POST" id="frmlogout" style="margin-bottom: 8px !important;">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <form action="<?php echo e(route('logout')); ?>" method="POST" id="frmlogout" style="margin-bottom: 8px !important;">
                                                <?php echo csrf_field(); ?>
                                            <a href="#/Logout" class="h-bg-slack LoadingUi" id="submitLogout">
                                                <span class="ts-icon"><i class="fa-solid fa-right-from-bracket"></i></span><span class="ts-text">Exit</span>
                                            </a>
                                        ...
                                        <li class="language-selector-container mt-2">
                                            <div class="language-dropdown-wrapper">
                                                <button class="language-btn" type="button" id="languageDropdown" onclick="toggleLanguageDropdown()" title="<?php echo e(__('Language')); ?>">
                                                    ...
                                                    <span class="language-code"><?php echo e(strtoupper(app()->getLocale())); ?></span>
                                                    <i class="fas fa-chevron-down language-arrow" id="languageArrow"></i>
                                                </button>
                                                <div class="language-menu" id="languageMenu" style="display: none;">
                                                    <a class="language-item <?php echo e(app()->getLocale() == 'en' ? 'active' : ''); ?>" 
                                                       href="<?php echo e(route('lang.change', 'en')); ?>" 
                                                    ...
                                                    <a class="language-item <?php echo e(app()->getLocale() == 'ar' ? 'active' : ''); ?>" 
                                                       href="<?php echo e(route('lang.change', 'ar')); ?>" 
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp81\htdocs\aljeri-joil-yaseer-o3mhigh\resources\views/partials/header.blade.php ENDPATH**/ ?>