...
<div class="container clearfix">
    ...
    padding-left: 5%;">
            <div class="feature-box fbox-plain">
                ...
                <h3 class="mt-2"><a href="new-service.html">{{ __('New Service/Tag') }}</a> </h3>
    ...
    <div class="row col-sm-12">
        <h3 style="margin-bottom: 18px;"><i class="bi-hurricane"></i>	{{ __('Actions') }}</h3>
    ...
    <div class="row col-sm-12">
        ...
        <ul class="nav canvas-alt-tabs tabs-alt tabs-tb tabs nav-tabs mb-3" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link pending-approvals " data-bs-toggle="pill" data-bs-target="#Pending-tb" type="button" role="tab" aria-controls="canvas-home-tb" aria-selected="true"> {{ __('Services History') }} <span class="badge bg-success text-white">4</span></button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link notify-approvals active" data-bs-toggle="pill" data-bs-target="#Notifications-tb" type="button" role="tab" aria-controls="canvas-profile-tb" aria-selected="false">{{ __('Notifications') }} <span class="badge bg-success text-white">3</span></button>
            </li>
            ...
            <div class="tab-pane fade" id="Pending-tb" role="tabpanel" aria-labelledby="canvas-home-tb-tab" tabindex="0">
                <div class="col-12 row">
                    <table   class="table table-striped table-bordered dataTable datatableOnDashboardActions" cellspacing="0" width="100%" role="grid" aria-describedby="datatable1_info" style="width: 100%;">
                        <thead>
                        <tr role="row">
                            <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" width="50">{{ __('No.') }}</th>
                            <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 221px;">{{ __('Service Types') }}</th>
                            <th class="sorting" tabindex="0" aria-controls="datatable1" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending">{{ __('Status') }}</th>



                            <th class="sorting" tabindex="0" aria-controls="datatable1" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">{{ __('Created date') }}</th>
                            <th class="sorting" tabindex="0" aria-controls="datatable1" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" width="150">{{ __('Actions') }}</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr class="">
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-sm btn-outline-primary  ms-2">{{ __('Details') }}</a>
            ...
            <div class="tab-pane fade  show active" id="Notifications-tb" role="tabpanel" aria-labelledby="canvas-profile-tb-tab" tabindex="0">
                ...
                <div class="col-12 row">
                    <div class="alert alert-dismissible alert-success">
                        <i class="bi-boxes"></i><strong>{{ __('Well done!') }}</strong> {{ __('You successfully read this') }} <a href="#" class="alert-link">{{ __('important alert message') }}</a>.
                        <button type="button" class="btn-close btn-sm" data-bs-dismiss="alert" aria-hidden="true"></button>
                    </div>
                    <div class="alert alert-dismissible alert-info">
                        <i class="bi-hand-index"></i><strong>{{ __('Heads up!') }}</strong> {{ __('This alert needs your attention, but it\\'s not super important.') }}
                        <button type="button" class="btn-close btn-sm" data-bs-dismiss="alert" aria-hidden="true"></button>
                    </div>
                    <div class="alert alert-dismissible alert-danger mb-0">
                        <i class="bi-x-circle-fill"></i><strong>{{ __('Oh snap!') }}</strong> {{ __('Change a few things up and try submitting again.') }}
                        <button type="button" class="btn-close btn-sm" data-bs-dismiss="alert" aria-hidden="true"></button>
                    </div>
