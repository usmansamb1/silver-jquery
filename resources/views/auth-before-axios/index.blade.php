                    ...
                    <div id="login_form">
                        ...
                        <form id="loginForm">
                            <div class="form-group input-with-icon">
                                ...
                                <input type="text" id="login_mobile" name="mobile" class="form-control"  pattern="^(05\d{8}|5\d{8,9})$" title="Mobile must start with 05 or 5 and be 9 or 10 digits"  placeholder="Enter your mobile number" required>
                            </div>
                        ...
                        <form method="POST" action="{{ route('api.register') }}">
                            ...
                            <div id="personal_fields">
                                ...
                                <div class="form-group input-with-icon">
                                    ...
                                    <input type="text" name="mobile" id="mobile" class="form-control"  pattern="^(05\d{8}|5\d{8,9})$" title="Mobile must start with 05 or 5 and be 9 or 10 digits"  placeholder="Enter your mobile number" required>
                                </div>
                                <div class="form-group input-with-icon">
                            ...
                            <div id="company_fields" style="display:none;">
                                ...
                                <div class="form-group input-with-icon">
                                    ...
                                    <input type="text" name="mobile" id="mobile_company" class="form-control"  pattern="^(05\d{8}|5\d{8,9})$" title="Mobile must start with 05 or 5 and be 9 or 10 digits"  placeholder="Enter company mobile" required>
                                </div>
                                <div class="form-group input-with-icon">
...
<script>
    $(document).ready(function() {
        ...
        $('#loginForm').submit(function(e) {
            ...
            axios.post('/api/login', { mobile: mobile, otp: '' })  // Assuming backend will send OTP on mobile login
                .then(response => {
        ...
        $('#otpForm').submit(function(e) {
            e.preventDefault();
            const otp = $('#otp').val();
            axios.post('/api/login/verify', { otp: otp }) // Your OTP verification endpoint
                .then(response => {
     ...
     /*   axios.get('/api/example')
        ...
        $('#verifyOtpBtn').on('click', function() {
            ...
            // Example:
            // axios.post('/api/login/verify', { mobile: '...', otp: fullOtp })
            //   .then(response => {
            //     // success
            //   })
            //   .catch(error => {
