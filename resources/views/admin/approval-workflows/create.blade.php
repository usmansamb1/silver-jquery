        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">{{ __('admin-approvals.workflow.create_workflow') }}</h5>
                    ...
                    <form action="{{ route('admin.approval-workflows.store') }}" method="POST" id="workflow-form">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" 
                                           ...
                                           {{ old('notify_by_email', true) ? 'checked' : '' }}>
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" 
                                           ...
                                           {{ old('notify_by_sms', true) ? 'checked' : '' }}>
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> {{ __('admin-approvals.workflow.create_workflow') }}
                            </button>
                        </div>
                    </form>
                </div>
