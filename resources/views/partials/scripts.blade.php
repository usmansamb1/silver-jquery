...
<script src="{{ asset('theme_files/js/plugins.fitvids.js') }}"></script>
<script src="{{ asset('theme_files/js/plugins.lightbox.js') }}"></script>
<script src="{{ asset('theme_files/js/plugins.flexslider.js') }}"></script>
...
<script>
    ...
    function changeLanguage(locale) {
        ...
        window.location.href = '{{ route("lang.change", "") }}/' + locale;
    }
</script>
